	...
	#수업내용
		...
		07.20 월: ch08_인터페이스
		07.21 화: ch09_중첩 클래스와 중첩 인터페이스, 이론 정리(chap05.txt)
		07.22 수: 이론 정리(chap06.txt 작성중)
		07.23 목: 수업(ch09_중첩클래스와 중첩인터페이스), 이론 정리(chap06/chap07/chap08.txt, chap09.txt 작성중)
		07.24 금: 수업(ch09_중첩클래스와 중첩인터페이스, ch10_예외처리), 이론 정리(chap09.txt, chap10.txt.작성중)
		07.26 일: 이론 복습 및 오타 체크

		07.27 월: 수업(ch10_예외처리, ch11_기본API클래스), 이론 정리(chap10.txt)
