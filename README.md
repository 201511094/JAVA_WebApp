	...
	#수업내용
		...
		07.22 수: 이론정리(chap06.txt 작성중)
		07.23 목: 수업(ch09_중첩클래스와 중첩인터페이스), 이론정리(chap06/chap07/chap08.txt, chap09.txt 작성중)
		07.24 금: 수업(ch09, ch10_예외처리), 이론정리(chap09.txt, chap10.txt 작성중)
		07.26 일: 이론복습 및 오타체크

		07.27 월: 수업(ch10, ch11_기본API클래스), 이론정리(chap10.txt, chap11.txt 작성중)
		07.28 화: 수업(ch11), 이론정리(...)
